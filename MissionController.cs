...
{   
    ...
    public GameObject[] m_Camera; //ミッション０のカメラ
    ...
    void Start()
    {
        ...
        m_Camera = GameObject.FindGameObjectsWithTag("MissionCamera");
        foreach (GameObject obj in m_Camera)
        {
            obj.SetActive(false);
        }
    }
    ...
    void Update()
    {
        ...
        if(nowMission == Mission.Mission0)
        {
            ...
            {
                m_Camera[m_Camera.Length - 1].SetActive(true);
        ...
        else if (nowMission == Mission.Mission1)
        {
            ...
            {
                m_Camera[m_Camera.Length - 2].SetActive(true);
        ...
        else if (nowMission == Mission.Mission2)
        {
            ...
            {
                m_Camera[m_Camera.Length - 3].SetActive(true);
        ...
        else if(nowMission == Mission.Mission3)
        {
            ...
            {
                m_Camera[m_Camera.Length - 4].SetActive(true);
